...
def parse_csv(dados_emp):
    ...
    if len(dados_emp) == 53:
        empresas['NomeEmpresa'] = str(dados_emp[0].text)
        empresas['Telefone'] = str(dados_emp[48].text)
        empresas['Mercado'] = str('')
        empresas['Produtos'] = str(dados_emp[21].text)
        empresas['Site'] = str(dados_emp[52].text)
        empresas['Pais'] = str('Brasil')
        empresas['Estado'] = str('BA')
        empresas['Cidade'] = str(dados_emp[42].text)
        empresas['Logradouro'] = str(dados_emp[36].text)
        empresas['Numero'] = str('S/N')
        empresas['Bairro'] = str(dados_emp[40].text)
        empresas['CEP'] = str(dados_emp[46].text)
        empresas['Telefone2'] = str('')
        empresas['CpfCnpj'] = str(dados_emp[2])
        empresas['Email'] = str(dados_emp[50].text)
        return empresas
    if len(dados_emp) == 51:
        empresas['NomeEmpresa'] = str(dados_emp[0].text)
    ...
    if len(dados_emp) == 49:
        empresas['NomeEmpresa'] = str(dados_emp[0].text)
        empresas['Telefone'] = str(dados_emp[46].text)
        empresas['Mercado'] = str('')
        ...
        empresas['Numero'] = str('S/N')
        empresas['Bairro'] = str(dados_emp[36].text)
        empresas['CEP'] = str(dados_emp[42].text)
        empresas['Telefone2'] = str('')
        empresas['CpfCnpj'] = str(dados_emp[2])
        empresas['Email'] = str(dados_emp[46].text)
        return empresas
    if len(dados_emp) == 48:
        empresas['NomeEmpresa'] = str(dados_emp[0].text)
